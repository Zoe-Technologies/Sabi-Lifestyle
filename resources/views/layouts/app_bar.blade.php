...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Dashboard | Sabi Lifestyle</title>
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img class="rounded-circle header-profile-user" src="{{ asset('assets/images/users/avatar-1.jpg') }}"
                                    alt="Header Avatar">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium">Solomon</span>
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="javascript: void(0);" class="has-arrow">
                                    ...
                                    <span data-key="t-contacts">Customers</span>
                                </a>
                            </li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="text-sm-end d-none d-sm-block">
                                  Developed by <a href="" class="text-decoration-underline">ZoeTechnologies</a>
                                </div>
                            </div>
                        </div>
                    </div>
